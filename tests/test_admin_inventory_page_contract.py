...
class AdminInventoryPageContractTest(unittest.TestCase):
    ...
    def test_react_inventory_page_follows_inventory_handbook_contract(self):
        ...
        self.assertIn("rowPieceText", inventory_source)
        self.assertIn("inventory-product-piece", inventory_source)
        self.assertIn("inventory-sku-piece", inventory_source)
        ...
        self.assertIn('"simple_desc": piece', inventory_balances_source)
