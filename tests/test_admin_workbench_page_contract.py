...
class AdminWorkbenchPageContractTest(unittest.TestCase):
    ...
    def test_purchase_result_has_scoped_copy_button(self):
        ...
        result_dialog_section = extract_function_section(workbench_source, "WorkbenchResultDialog")

        self.assertNotIn("purchaseResultFirstLine", result_table_section)
        self.assertNotIn("purchaseResultFirstLine", message_section)
        self.assertNotIn("<PurchaseResultCopyButton", result_table_section)
        self.assertNotIn("<PurchaseResultCopyButton", message_section)
        self.assertIn("<PurchaseResultCopyButton", result_dialog_section)
        self.assertIn('aria-label="复制进货信息"', copy_button_section)
        self.assertIn("复制进货信息", copy_button_section)
        ...
        self.assertLess(result_dialog_section.index("<PurchaseResultCopyButton"), result_dialog_section.index(">关闭</Button>"))
        self.assertNotIn(".workbench-result-copy", styles_source)
        self.assertNotIn(".workbench-message-purchase-title", styles_source)
    ...
    def test_workbench_upload_keeps_image_visible_in_user_message(self):
        ...
        choose_section = extract_function_section(workbench_source, "chooseFiles")
        paste_section = extract_function_section(workbench_source, "handlePaste")

        self.assertIn("WORKBENCH_UPLOAD_ACCEPT", workbench_source)
        self.assertIn('".zip"', workbench_source)
        self.assertIn("function isWorkbenchUploadFile", workbench_source)
        self.assertIn("isZipUploadFile", workbench_source)
        self.assertIn("filter(isWorkbenchUploadFile)", choose_section)
        self.assertIn("filter(isWorkbenchUploadFile)", paste_section)
        self.assertIn("filter(isWorkbenchUploadFile)", workbench_source)
        ...
        self.assertIn("upload_label", http_source)
